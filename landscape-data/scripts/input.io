EventRemapper doFile(Config scripts_dir .. "/keysyms.io")
EventRemapper do(
  press := Object
  release := Nil
  ...
  mapKey(SDLK_HOME, press, "autopilot")
  mapKey(SDLK_p, press, "pause")
  mapKey(SDLK_CARET, press, "toggle-console")
  ...
  mapKey(SDLK_F9, press, "faster")
  mapKey(SDLK_F10, press, "slower")
  ...
  mapJoystickAxis(0,2,"js_rudder")
  mapJoystickAxis(0,3,"js_throttle")
)
