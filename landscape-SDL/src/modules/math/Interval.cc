...
template
IntervalBase<float> std::abs<>(const IntervalBase<float> & X);
template
IntervalBase<float> std::cos<>(const IntervalBase<float> & X);
template
IntervalBase<float> std::sin<>(const IntervalBase<float> & X);
template
std::istream & operator>> (std::istream & is,
