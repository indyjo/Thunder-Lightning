...
template<class T> class IFactory : public Object
{
public:
    virtual T * create()=0;
};
...
template<class T, class P1>
        class IFactory1 : public Object
{
public:
    virtual T * create(P1)=0;
};

template<class T, class P1, class P2>
        class IFactory2 : public Object
{
public:
...
template<class T, class P1, class P2, class P3>
        class IFactory3 : public Object
{
public:
    virtual T * create(P1, P2, P3)=0;
};

template<class T, class P1, class P2, class P3, class P4>
        class IFactory4 : public Object
{
public:
    virtual T * create(P1, P2, P3, P4)=0;
};

template<class T, class P1, class P2, class P3, class P4, class P5>
        class IFactory5 : public Object
{
public:
    virtual T * create(P1, P2, P3, P4, P5)=0;
};
...
{
public:
    virtual T * create(P1 p1, P2 p2, P3 p3)
...
{
public:
    virtual T * create(P1 p1, P2 p2, P3 p3, P4 p4)
...
{
public:
    virtual T * create(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5)
